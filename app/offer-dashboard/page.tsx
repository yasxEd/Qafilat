...
import { useOffersData, type Offre, type Hotel, type DateDisponible, type TarifsChambre } from '@/lib/useOffersData';
...
const OffresDashboard = () => {
  const { offres, isLoaded, addOffre, updateOffre, deleteOffre: removeOffre } = useOffersData();
