...
import { Home, Users, Calendar, LogOut, Menu, X, Package, Bell, BarChart2, ChevronLeft } from "lucide-react"
...
export default function AdminDashboardLayout({ children }: AdminDashboardLayoutProps) {
  ...
  const menuItems = [
    { name: "Tableau de bord", icon: Home, href: "/admin/dashboard" },
    { name: "Clients", icon: Users, href: "/admin/dashboard/clients" },
    { name: "Agences", icon: Package, href: "/admin/dashboard/agencies" },
    { name: "Réservations", icon: Calendar, href: "/admin/dashboard/reservations" },
    { name: "Notifications", icon: Bell, href: "/admin/dashboard/notifications" },
    { name: "Rapports", icon: BarChart2, href: "/admin/dashboard/reports" },
  ]
        ...
        <div className="flex flex-col h-full">
          ...
          >
            <div className="flex items-center">
              ...
              {(!sidebarCollapsed || isMobile) && <span className="font-semibold text-gray-800">Administration</span>}
            </div>
            {isMobile && (
