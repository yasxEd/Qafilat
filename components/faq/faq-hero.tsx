    ...
    <section className="relative h-[50vh] md:h-[60vh] flex items-end overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 pb-16">
        <motion.div
          ...
          className="max-w-lg"
        >
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Questions Fréquentes</h1>
          <div className="w-16 h-1 bg-[#FFD700] mb-4"></div>
          <p className="text-white/80 text-sm md:text-base">
            Trouvez des réponses à toutes vos questions concernant les voyages de Hajj et Omra avec Qafilat Tayba.
          </p>
        </motion.div>
      </div>
